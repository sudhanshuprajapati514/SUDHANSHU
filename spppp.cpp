...
//     cout<<num[i]<<endl;
//     }
//     cout<<"elementn at index 4 is" <<num.at(4)<<endl;
// return 0;
// }



// particular place prr elment ko change karna 
// #include<iostream>
// #include<vector>
// using namespace std;
// int main()
...
//     }
//     num.at(3)=45;
//     cout<<"after changing the element at index 3"<<endl;
//     for(int i=0;i<num.size();i++)
//     {
//         cout<<num[i]<<endl;
//     }      
...
// remove all the elements of the ventor (syntax clear)
// #include<iostream>
// #include<vector>
// using namespace std;
// int main()      
// {
//     vector<int> num ,size(10);
//     int element;
//     cout<<"enter the number of elements you want to insert"<<endl;
//     for(int i=0;i<10;i++)
//     {
